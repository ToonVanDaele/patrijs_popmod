...
## Stochastische sensitiviteit per parameter

Voor de stochastische sensitiviteit van de matrix elementen gebruiken
we de popbio functie stoch.sens (hierboven).

Zijn we ook geïnteresseerd in de sensitiviteit van de individuele parameters die 
de matrixelementen, dan moeten we parameters per parameter de berekening maken.

Eerst een voorbeeld voor een deterministisch model
